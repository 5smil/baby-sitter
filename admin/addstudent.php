...
<div class="container jumbotron">
	<div class="row">
		<div class="col-md-6 col-md-offset-3">
			<h2 class="text-center">اضافه تفاصيل الاطفال</h2>
			<form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="post" enctype="multipart/form-data">
				  <div class="form-group">
				      رقم الطفل.:<input type="text" class="form-control" name="roll" placeholder="ادخل رقم الطفل" >
				  </div>
				  <div class="form-group">
				  ...
				  <div class="form-group">
				    ...
				    رقم ولي الامر.:<input type="text" class="form-control" name="pphone" placeholder="رقم ولي الامر" required>
				  </div>
				  <div class="form-group">
				    
				    العمر:<input type="number" class="form-control" name="standard" placeholder="العمر" required>
				  </div>
