	...
	<div class="row">
		<div class="col-md-6 col-md-offset-3">
			...
			<form action="UpdateRecord.php?update_id=<?php echo $update_id;?>" method="post" enctype="multipart/form-data">
				  ...
				  <div class="form-group">
				   رقم ولي الامر:<input type="text" class="form-control" name="pphone" value="<?php echo $Pcontact;?>" required>
				  </div>
				  <div class="form-group">
				    
				   العمر:<input type="number" class="form-control" name="standard" value="<?php echo $Standard;?>" required>
				  </div>
