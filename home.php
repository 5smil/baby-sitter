 ...
 include('header.php')
  ?>
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12 jumbotron">
                        ...
                        مرحــــــباً بكم في نظام  حضانة الاطفال 
                                <span style="float: right;"><a href="admin/admindash.php" class="btn btn-info btn-lg">لوحة التحكم</a></span>
                            </h2>
                    </div>
                </div>
            </div>
            ...
            <div class="student-info text-center">
                ...
                <input type="text" name="roll" placeholder="ادخل رقم الطفل" style="width: 240px;height: 35px;"><span><span>
                 <select name="standard" class="btn btn-info" >
                             <option>اختيار العمر</option>
                                    <option>2</option>
                                    <option>3</option>
                                    <option>4</option>
                                    <option>5</option>
...
<table class="table table-striped table-bordered table-responsive text-center" >
    <tr  dir="rtl">
        ...
        <th class="text-center">رقم ولي الامر</th>
